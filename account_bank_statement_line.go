...
type AccountBankStatementLine struct {
	...
	L10NEsEdiVerifactuAvailableClaveRegimens *String     `xmlrpc:"l10n_es_edi_verifactu_available_clave_regimens,omitempty"`
	L10NEsEdiVerifactuClaveRegimen           *Selection  `xmlrpc:"l10n_es_edi_verifactu_clave_regimen,omitempty"`
	L10NEsEdiVerifactuDocumentIds            *Relation   `xmlrpc:"l10n_es_edi_verifactu_document_ids,omitempty"`
	L10NEsEdiVerifactuQrCode                 *String     `xmlrpc:"l10n_es_edi_verifactu_qr_code,omitempty"`
	L10NEsEdiVerifactuRefundReason           *Selection  `xmlrpc:"l10n_es_edi_verifactu_refund_reason,omitempty"`
	L10NEsEdiVerifactuRequired               *Bool       `xmlrpc:"l10n_es_edi_verifactu_required,omitempty"`
	L10NEsEdiVerifactuShowCancelButton       *Bool       `xmlrpc:"l10n_es_edi_verifactu_show_cancel_button,omitempty"`
	L10NEsEdiVerifactuState                  *Selection  `xmlrpc:"l10n_es_edi_verifactu_state,omitempty"`
	L10NEsEdiVerifactuSubstitutedEntryId     *Many2One   `xmlrpc:"l10n_es_edi_verifactu_substituted_entry_id,omitempty"`
	L10NEsEdiVerifactuSubstitutionMoveIds    *Relation   `xmlrpc:"l10n_es_edi_verifactu_substitution_move_ids,omitempty"`
	L10NEsEdiVerifactuWarning                *String     `xmlrpc:"l10n_es_edi_verifactu_warning,omitempty"`
	L10NEsEdiVerifactuWarningLevel           *String     `xmlrpc:"l10n_es_edi_verifactu_warning_level,omitempty"`
	L10NEsInvoicingPeriodEndDate             *Time       `xmlrpc:"l10n_es_invoicing_period_end_date,omitempty"`
	L10NEsInvoicingPeriodStartDate           *Time       `xmlrpc:"l10n_es_invoicing_period_start_date,omitempty"`
	L10NEsIsSimplified                       *Bool       `xmlrpc:"l10n_es_is_simplified,omitempty"`
	L10NEsPaymentMeans                       *Selection  `xmlrpc:"l10n_es_payment_means,omitempty"`
