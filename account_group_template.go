...
func (c *Client) CreateAccountGroupTemplates(agts []*AccountGroupTemplate) ([]int64, error) {
	...
	return c.Create(AccountGroupTemplateModel, vv, nil)
}
...
func (c *Client) UpdateAccountGroupTemplates(ids []int64, agt *AccountGroupTemplate) error {
	return c.Update(AccountGroupTemplateModel, ids, agt, nil)
}
...
func (c *Client) FindAccountGroupTemplateIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(AccountGroupTemplateModel, criteria, options)
}
