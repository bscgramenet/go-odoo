...
type StockMove struct {
	...
	AnalyticAccountLineId    *Many2One  `xmlrpc:"analytic_account_line_id,omitempty"`
	...
	DisplayClearSerial       *Bool      `xmlrpc:"display_clear_serial,omitempty"`
	...
	FromImmediateTransfer    *Bool      `xmlrpc:"from_immediate_transfer,omitempty"`
