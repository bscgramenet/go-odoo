...
type ProjectProject struct {
	...
	AliasEnabled                 *Bool       `xmlrpc:"alias_enabled,omitempty"`
	...
	AliasValue                   *String     `xmlrpc:"alias_value,omitempty"`
	...
	TaskCountWithSubtasks        *Int        `xmlrpc:"task_count_with_subtasks,omitempty"`
