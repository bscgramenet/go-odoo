...
func (c *Client) CreateSnailmailConfirmInvoices(scis []*SnailmailConfirmInvoice) ([]int64, error) {
	...
	return c.Create(SnailmailConfirmInvoiceModel, vv, nil)
}
...
func (c *Client) UpdateSnailmailConfirmInvoices(ids []int64, sci *SnailmailConfirmInvoice) error {
	return c.Update(SnailmailConfirmInvoiceModel, ids, sci, nil)
}
...
func (c *Client) FindSnailmailConfirmInvoiceIds(criteria *Criteria, options *Options) ([]int64, error) {
	return c.Search(SnailmailConfirmInvoiceModel, criteria, options)
}
