...
type AccountTaxRepartitionLineTemplate struct {
	...
	MinusReportExpressionIds *Relation  `xmlrpc:"minus_report_expression_ids,omitempty"`
	PlusReportExpressionIds  *Relation  `xmlrpc:"plus_report_expression_ids,omitempty"`
