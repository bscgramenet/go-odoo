...
type PosOrder struct {
	...
	CourseIds                      *Relation   `xmlrpc:"course_ids,omitempty"`
	...
	CustomerCount                  *Int        `xmlrpc:"customer_count,omitempty"`
	...
	GeneralCustomerNote            *String     `xmlrpc:"general_customer_note,omitempty"`
	...
	PresetId                       *Many2One   `xmlrpc:"preset_id,omitempty"`
	PresetTime                     *Time       `xmlrpc:"preset_time,omitempty"`
	...
	ReversedMoveIds                *Relation   `xmlrpc:"reversed_move_ids,omitempty"`
	SaleJournal                    *Many2One   `xmlrpc:"sale_journal,omitempty"`
	SaleOrderCount                 *Int        `xmlrpc:"sale_order_count,omitempty"`
	SelfOrderingTableId            *Many2One   `xmlrpc:"self_ordering_table_id,omitempty"`
	...
	Source                         *Selection  `xmlrpc:"source,omitempty"`
	State                          *Selection  `xmlrpc:"state,omitempty"`
	StockReferenceIds              *Relation   `xmlrpc:"stock_reference_ids,omitempty"`
	TableId                        *Many2One   `xmlrpc:"table_id,omitempty"`
	TableStandNumber               *String     `xmlrpc:"table_stand_number,omitempty"`
	...
	UseSelfOrderOnlinePayment      *Bool       `xmlrpc:"use_self_order_online_payment,omitempty"`
	UserId                         *Many2One   `xmlrpc:"user_id,omitempty"`
	Uuid                           *String     `xmlrpc:"uuid,omitempty"`
	VmaiGiftCardsJson              interface{} `xmlrpc:"vmai_gift_cards_json,omitempty"`
