...
type ResCompany struct {
	...
	L10NEsEdiFacturaeCertificateIds             *Relation   `xmlrpc:"l10n_es_edi_facturae_certificate_ids,omitempty"`
	...
	L10NEsEdiVerifactuChainSequenceId           *Many2One   `xmlrpc:"l10n_es_edi_verifactu_chain_sequence_id,omitempty"`
	L10NEsEdiVerifactuNextBatchTime             *Time       `xmlrpc:"l10n_es_edi_verifactu_next_batch_time,omitempty"`
